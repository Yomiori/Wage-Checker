...
class AdManager {
    constructor() {
        this.adConfig = {
            ...
            publisherId: 'ca-pub-XXXXXXXXXX', // Replace with real publisher ID
            adSlots: {
                header: 'XXXXXXXXXX',
                sidebar: 'XXXXXXXXXX', 
                bottom: 'XXXXXXXXXX'
        ...
        this.demoAds = [
            {
                ...
                description: "Boost your skills with online courses. Get certified and increase your earning potential.",
                url: "#",
                image: "https://via.placeholder.com/300x250/4f46e5/ffffff?text=Career+Courses"
            },
            {
                title: "Resume Writing Services",
                description: "Professional resume writing to help you land your dream job and negotiate better salary.",
                url: "#",
                image: "https://via.placeholder.com/300x250/059669/ffffff?text=Resume+Help"
            },
            {
                title: "Salary Negotiation Guide",
                description: "Learn proven strategies to negotiate higher salaries and better benefits packages.",
                url: "#",
                image: "https://via.placeholder.com/728x90/dc2626/ffffff?text=Salary+Negotiation"
            },
            {
                title: "Job Search Platform",
                description: "Find high-paying jobs in your area. Connect with top employers and recruiters.",
                url: "#",
                image: "https://via.placeholder.com/728x90/7c3aed/ffffff?text=Job+Search"
            }
        ];
        ...
        if (headerAd) {
            ...
            headerAd.innerHTML = `
                <div style="background: linear-gradient(135deg, ${this.getRandomColor()}, ${this.getRandomColor()}); 
                    ...
                    <h3 style="margin: 0 0 0.5rem 0; font-size: 1.1rem;">${ad.title}</h3>
                    <p style="margin: 0; font-size: 0.9rem; opacity: 0.9;">${ad.description}</p>
            ...
            sidebarAd.innerHTML = `
                <div style="background: white; border: 1px solid #e5e7eb; border-radius: 8px; overflow: hidden; height: 100%;">
                    <div style="background: ${this.getRandomColor()}; color: white; padding: 1rem; text-align: center;">
                        <h4 style="margin: 0 0 0.5rem 0; font-size: 1rem;">${ad.title}</h4>
                        <p style="margin: 0; font-size: 0.85rem; opacity: 0.9;">${ad.description}</p>
                    </div>
